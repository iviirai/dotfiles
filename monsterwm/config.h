...
#define FOCUS           "#FA6B6B" /* focused window border color   */
#define UNFOCUS         "#6E464B" /* unfocused window border color */
...
static Key keys[] = {
    ...
    {  MOD1|SHIFT,       XK_c,          switch_mode,       {.i = BSTACK}},
    {  MOD1|SHIFT,       XK_w,          switch_mode,       {.i = GRID}},
